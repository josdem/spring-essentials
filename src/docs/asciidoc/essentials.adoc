...
Actualmente, Springframework es una plataforma Java que provee del soporte comprensivo de infraestructura para desarrollar aplicaciones para la JVM. Maneja y administra la infraestructura de tal manera que podemos enfocarnos en el desarrollo de la aplicación.
...
** Soporte para la especificación JSR-330 en inyección de dependencias. Declaraciones basada en anotaciones de métodos calendarizados y asíncronos.
